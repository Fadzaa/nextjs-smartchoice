...
export default function LandingComponentFour() {
  return (
    <main className="w-full h-[70vh] mb-44 px-16 mt-32 ">
      <div
        className="w-full py-16  rounded-3xl flex gap-6 flex-col items-center justify-center  relative overflow-hidden"
