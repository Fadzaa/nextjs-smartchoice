...
function PartaiCard({number, image, party_name, description}) {
    return (
        <div className="
        ...
        ">
            ...
            />
            <div className="
            bg-[#FBFBFB] bg-opacity-95 w-full h-[80px]
            ...
            group-hover:h-full group-hover:absolute flex flex-col items-center justify-center p-6">
                <h3 className="text-[#4D4D4D] text-[20px] font-semibold text-center">{party_name}</h3>
